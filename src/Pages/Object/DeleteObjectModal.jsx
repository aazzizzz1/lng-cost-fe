...
const DeleteObjectModal = ({ isOpen, onClose, onDelete, object }) => {
  const handleDelete = () => {
    onDelete(object.id); // Delete by objectId or any unique identifier
    onClose();
  };
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
        <div className="p-6 text-center">
          ...
          <h3 className="mb-5 text-lg font-normal text-gray-900 dark:text-white">
            Are you sure you want to delete this {object.name}?
          </h3>
          <button
            type="button"
