...
import SuccessAlertMatrix from "../../Components/Alerts/MatrixAlert/SuccessAlertMatrix";
import ErrorAlertMatrix from "../../Components/Alerts/MatrixAlert/ErrorAlertMatrix";
...
const MatrixManagement = () => {
  ...
  const successMessage = useSelector((state) => state.matrix.successMessage);
  const errorMessage = useSelector((state) => state.matrix.errorMessage);
  const shouldfetchMatrix = useSelector(
    (state) => state.matrix.shouldfetchMatrix
  );
  ...
  useEffect(() => {
    if (shouldfetchMatrix) {
      dispatch(fetchMatrix());
    }
  }, [shouldfetchMatrix, dispatch]);
