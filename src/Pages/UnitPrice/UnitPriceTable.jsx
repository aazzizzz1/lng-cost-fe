                          ...
                          user?.role === 'admin' && (
                            <div className="flex items-center gap-1.5">
                              ...
                              <button
                                ...
                                className="inline-flex items-center justify-center w-8 h-8 rounded-md bg-rose-600 text-white hover:bg-rose-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-rose-300 dark:focus:ring-rose-600 shadow-sm"
                              >
                                <TrashIcon />
                              </button>
                            </div>
