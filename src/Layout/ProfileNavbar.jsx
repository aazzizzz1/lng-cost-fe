...
const ProfileNavbar = ({ profileRef: propProfileRef }) => {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (isProfileOpen && ref.current && !ref.current.contains(event.target)) {
    ...
    <>
      ...
      <div
        ...
        className={`
          ...
          ${isProfileOpen ? 'opacity-100 scale-100 pointer-events-auto visible' : 'opacity-0 scale-95 pointer-events-none invisible'}
        `}
        style={{ minWidth: 260 }}
      >
        {isProfileOpen && (
