...
const BottomNavSidebar = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full flex justify-center items-center p-4 space-x-4 bg-white dark:bg-gray-800 z-20">
        <a
          href="#askjd"
        ...
        <div
          ...
          className={`
            absolute bottom-16 z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700
            transition-all duration-200 ease-in-out
            ${dropdownOpen ? 'opacity-100 scale-100 pointer-events-auto visible' : 'opacity-0 scale-95 pointer-events-none invisible'}
          `}
        >
...
export default BottomNavSidebar