...
export const GlobalProvider = (props) => {
  ...
  const handleSignUp = (event) => {
    ...
    axios
      ...
      .catch((err) => {
        ...
        const isUserNotRegistered = errorValidation.includes(
  ...
  const parseCookieExpires = (setCookieHeader) => {
    ...
    const oneDayInMillis = 3 * 60 * 60 * 1000;
  ...
  const handleLogin = (event) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        Cookies.set(`user`, data.user.username, { expires: tokenExpires });
        Cookies.set(`id`, data.user.id, { expires: tokenExpires });
        Cookies.set(`full_name`, data.user.full_name, {
          expires: tokenExpires,
        });
        Cookies.set(`role`, data.user.role, { expires: tokenExpires });
      ...
      .catch((err) => {
        ...
        const isUserPassword = errorValidation.includes(
  ...
  const handleToggleSidebarMobile = () => {
    ...
    console.log(sidebarToggleMobile);
    handleToggleSidebarClose();
    handleToggleSidebar();
  };
